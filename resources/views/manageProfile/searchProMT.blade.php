...
<div class="pb-3">
    ...
    <a href="{{ route('reportMentor', ['search' => request()->get('search'), 'P_Batch' => request()->get('P_Batch'), 'P_Status' => request()->get('P_Status')]) }}" class="btn btn-primary">Generate Platinum List</a>
</div>
    ...
    <div class="col-md-4">
        <div class="card card-custom">
            ...
            <div class="card-body">
                ...
                <a href="{{ route('detailPlatMT', ['P_IC' => $platinumMember->P_IC]) }}" class="btn">Details</a>
                <a href="{{ route('showDetailMT', ['P_IC' => $platinumMember->P_IC]) }}" class="btn">Expert & Publication Data</a>
            </div>
        </div>
    </div>
@endforeach
    ...
    <div class="col-md-4">
        <div class="card card-custom">
            ...
            <div class="card-body">
                ...
                <a href="{{ route('detailStaffMT', ['S_IC' => $staffMember->S_IC]) }}" class="btn">Details</a>
            </div>
        </div>
    </div>
@endforeach
    ...
    <div class="col-md-4">
        <div class="card card-custom">
            ...
            <div class="card-body">
                ...
                <a href="{{ route('detailMentorMT', ['M_IC' => $mentorMember->M_IC]) }}" class="btn">Details</a>
            </div>
        </div>
    </div>
@endforeach
